...
def play_game():
    ...
    while True:
        ...
        # TODO: Update random tile generation to account for new pick-three
        # implementation
        maxval = m.max()
...
def play_game_chrome(game_ctrl):

    # initialize the chrome controller
    moveno = 0
    while True:
